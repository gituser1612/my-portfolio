...
const ContactSection = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // 2. Validate Name (text only, no numbers or special chars)
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-8 ">
                ...
                <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:amitpandey02871@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">amitpandey02871@gmail.com</a>
                        </div>
                    </div>
                    <div className="flex items-start space-x-4">
                        <div className="p-3 rounded-full bg-primary/10">
                        ...
                        <div>
                            ...
                            <a href="tel:+919155840605" className="text-muted-foreground hover:text-primary transition-colors">+91 91558-40605</a>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <a  className="text-muted-foreground hover:text-primary transition-colors">Pune</a>
                        </div>
                    </div>
                ...
                <div className="pt-8">
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.linkedin.com/in/amit-kumar-pandey-649478284/"  target="_blank"> <Linkedin/></a>
                            <a href="https://x.com/amitpandey02871" target="_blank"> <Twitter/></a>
                            <a href="https://www.instagram.com/im_decode/" target="_blank"> <Instagram/></a>
                        </div>
                </div>
            </div>
            ...
            <div className="bg-card p-8 rounded-lg shadow-xs">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <button disabled={isSubmitting} className={cn("cosmic-button w-full flex items-center justify-center gap-2",)} type="submit">
